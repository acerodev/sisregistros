...
include ('../../app/controllers/stock/ListaStock.php');
...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container">
            <div class="row">
                <h1>Listado de Stock por Tipo</h1>
            </div>
            <br>
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card card-outline card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Stock registrados</h3>
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-striped table-bordered table-hover table-sm">
                                ...
                                <tr>
                                    ...
                                    <th><center>Número de Piso</center></th>
                                ...
                                foreach ($stocks as $stock){
                                    ...
                                    $contador_stocks = $contador_stocks +1; ?>
                                    <tr>
                                        <td style="text-align: center"><?=$contador_stocks;?></td>
                                        <td><?=$stock['descripcion'];?></td>
                                        <td><?=$stock['dependencia_area'];?></td>
                                        <td><?='Piso: '.$stock['piso'];?></td>
                                        <td style="text-align: right"><?=$stock['cantidad'];?></td>
                                        <td style="text-align: center"><?=$stock['fecha_actualizacion'];?></td>
                                        <!--<td>
                                            <
                                            if($stock['estado'] == "1") echo "ACTIVO";
                                            else echo "INACTIVO";
                                            ?>
                                        </td>-->
    ...
    $(function () {
        $("#example1").DataTable({
            ...
            "language": {
                ...
                "info": "Mostrando _START_ a _END_ de _TOTAL_ Stocks Tipo",
                "infoEmpty": "Mostrando 0 a 0 de 0 Stocks Tipo",
                "infoFiltered": "(Filtrado de _MAX_ total Stocks Tipo)",
                "infoPostFix": "",
                "thousands": ",",
                "lengthMenu": "Mostrar _MENU_ Stocks Tipo",
