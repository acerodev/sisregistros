                        ...
                        <div class="card-body">
                            <form action="<?=APP_URL;?>/app/controllers/administrativos/create.php" method="post">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="form-inline">
                                                <select name="rol_id" id="" class="form-control" style="width: 100%;">
                                                    <?php
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="">Código Conductor</label>
                                            <input type="text" name="cod_conductor" class="form-control" placeholder="Registre solo si corresponde">
                                        </div>
                                    </div>
                                </div>
                                <hr>
