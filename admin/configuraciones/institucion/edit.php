                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <label for="">CD<b>*</b></label>
                                                    <input type="text" name="cd" value="<?=$cd;?>" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="">CIA<b>*</b></label>
                                                    <input type="text" name="cia" value="<?=$cia;?>" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
