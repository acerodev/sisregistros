...
include ('../../app/controllers/usuarios/ListaUsuarios.php');
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                ...
                                                <form action="<?=APP_URL;?>/app/controllers/usuarios/ActivarUser.php" onclick="preguntarA<?=$id_usuario;?>(event)" method="post" id="miFormularioA<?=$id_usuario;?>">
                                                    <input type="text" name="id_usuario" value="<?=$id_usuario;?>" hidden>
                                                    <button type="submit" class="btn btn-warning btn-sm" style="border-radius: 0px 0px 0px 0px"><i class="bi bi-check-square"></i></button>
                                                </form>
                                                <script>
                                                    function preguntarA<?=$id_usuario;?>(event) {
                                                        ...
                                                        Swal.fire({
                                                            ...
                                                            if (result.isConfirmed) {
                                                                var form = $('#miFormularioA<?=$id_usuario;?>');
                                                                form.submit();
                                                            }
                                                        });
                                                    }
                                                </script>
                                                <form action="<?=APP_URL;?>/app/controllers/usuarios/DesactivarUser.php" onclick="preguntar<?=$id_usuario;?>(event)" method="post" id="miFormulario<?=$id_usuario;?>">
                                                    <input type="text" name="id_usuario" value="<?=$id_usuario;?>" hidden>
