...
INNER JOIN administrativos as adm ON adm.persona_id = per.id_persona where adm.estado = '1' AND rol.id_rol = '9' ";
$query_administrativos = $pdo->prepare($sql_administrativos);
$query_administrativos->execute();
$conductores = $query_administrativos->fetchAll(PDO::FETCH_ASSOC);
