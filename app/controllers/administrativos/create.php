...
$cod_conductor = $_POST['cod_conductor'];
...
$sentencia = $pdo->prepare('INSERT INTO personas
         (usuario_id,cod_conductor,nombres,apellidos,ci,fecha_nacimiento,celular,profesion,direccion, fyh_creacion, estado)
VALUES ( :usuario_id,:cod_conductor,:nombres,:apellidos,:ci,:fecha_nacimiento,:celular,:profesion,:direccion,:fyh_creacion,:estado)');

$sentencia->bindParam(':usuario_id',$id_usuario);
$sentencia->bindParam(':cod_conductor',$cod_conductor);
