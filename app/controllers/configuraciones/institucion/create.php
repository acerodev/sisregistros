...
$sentencia = $pdo->prepare('INSERT INTO configuracion_instituciones
         (cd,cia,nombre_institucion,logo,direccion,telefono,celular,correo, fyh_creacion, estado)
VALUES ( :cd,:cia,:nombre_institucion,:logo,:direccion,:telefono,:celular,:correo,:fyh_creacion,:estado)');
